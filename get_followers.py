...
options.add_extension("/Users/karansingh/Downloads/instagram_msrit24/extension.crx")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/karansingh/Downloads/{}_followers.csv /Users/karansingh/Downloads/instagram_msrit24/accounts'.format(account))
        except:
